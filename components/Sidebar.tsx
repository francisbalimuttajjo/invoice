...
const Sidebar:React.FC<PropTypes>=(props)=>{
    ...
    return (
        <div className={` ${props.displayForm ? 'sm:rounded-none' :""} sticky top-0 z-50  bg-slate-800 h-20 flex sm:flex-col  sm:w-24   sm:h-screen sm:rounded-3xl sm:rounded-l-none`}>
